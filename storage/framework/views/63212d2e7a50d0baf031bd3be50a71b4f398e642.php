    ...
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            if (Session::get('role') == "Administrator") {
                ...
                <li class=" nav-item nav-dropdown <?php echo e(Request::is('cases*') ? 'active' : ''); ?>">
                    ...
                    <ul class="nav-dropdown-items">
                        ...
                        <li class="nav-item <?php echo e(Request::is('cases/all') ? 'active' : ''); ?>">
                            <a href="<?php echo e(url('cases/all')); ?>"  class="nav-link">
                                All Cases</a>
                        </li>
                        <li class="nav-item <?php echo e(Request::is('cases/agents') ? 'active' : ''); ?>">
                            <a href="<?php echo e(url('cases/agents')); ?>"  class="nav-link">
                                Agents Cases</a>
                        </li>
