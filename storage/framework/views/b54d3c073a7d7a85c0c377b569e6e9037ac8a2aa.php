        ...
        <div class="row">
            <div class="jarviswidget jarviswidget-sortable" id="wid-id-0" data-widget-editbutton="false" role="widget">
                ...
                <header role="heading" class="ui-sortable-handle">
                    <h2>Number of Cars entering and number of cars expiring over a day, week, month, year</h2>
                ...
                <div role="content">
                    ...
                    <div class="widget-body no-padding">
                        ...
                        <div id="bar-chart" class="chart" style="padding: 0px; position: relative;"><canvas class="flot-base" width="731" height="220" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 731px; height: 220px;"></canvas><div class="flot-text" style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; font-size: smaller; color: rgb(84, 84, 84);"><div class="flot-x-axis flot-x1-axis xAxis x1Axis" style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px;"><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 81px; top: 205px; left: 38px; text-align: center;">0</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 81px; top: 205px; left: 148px; text-align: center;">2</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 81px; top: 205px; left: 259px; text-align: center;">4</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 81px; top: 205px; left: 369px; text-align: center;">6</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 81px; top: 205px; left: 479px; text-align: center;">8</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 81px; top: 205px; left: 586px; text-align: center;">10</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 81px; top: 205px; left: 696px; text-align: center;">12</div></div><div class="flot-y-axis flot-y1-axis yAxis y1Axis" style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px;"><div class="flot-tick-label tickLabel" style="position: absolute; top: 188px; left: 6px; text-align: right;">0</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 157px; left: 6px; text-align: right;">5</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 126px; left: 0px; text-align: right;">10</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 95px; left: 0px; text-align: right;">15</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 64px; left: 0px; text-align: right;">20</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 33px; left: 0px; text-align: right;">25</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 3px; left: 0px; text-align: right;">30</div></div></div><canvas class="flot-overlay" width="731" height="220" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 731px; height: 220px;"></canvas></div>
...
<?php $__env->startSection('customjs'); ?>
		<script src="<?php echo e(asset('js/plugin/flot/jquery.flot.cust.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/plugin/flot/jquery.flot.resize.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/plugin/flot/jquery.flot.fillbetween.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/plugin/flot/jquery.flot.orderBar.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/plugin/flot/jquery.flot.pie.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/plugin/flot/jquery.flot.time.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/plugin/flot/jquery.flot.tooltip.min.js')); ?>"></script>
	<script>
