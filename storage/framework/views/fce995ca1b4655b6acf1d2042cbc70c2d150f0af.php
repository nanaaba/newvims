...
<script data-pace-options='{ "restartOnRequestAfter": true }' src="<?php echo e(asset('js/plugin/pace/pace.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('js/plugin/vectormap/jquery-jvectormap-1.2.2.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/plugin/vectormap/jquery-jvectormap-world-mill-en.js')); ?>"></script>

<!-- Full Calendar -->
<script src="<?php echo e(asset('js/plugin/moment/moment.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/plugin/fullcalendar/fullcalendar.min.js')); ?>"></script>

<!-- PAGE RELATED PLUGIN(S) -->
<script src="<?php echo e(asset('js/plugin/datatables/jquery.dataTables.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/plugin/datatables/dataTables.colVis.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/plugin/datatables/dataTables.tableTools.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/plugin/datatables/dataTables.bootstrap.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/plugin/datatable-responsive/datatables.responsive.min.js')); ?>"></script>
